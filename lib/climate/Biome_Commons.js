...
function Biome() {
    ...
    var DATA_FILE = path.resolve(GeoSphere.CLIMATE_ROOT, 'biome_data/biomes.csv');
...
Biome.biome_map = function(){

    var GeoSphere = require('./../../index');
    require(path.resolve(GeoSphere.CLIMATE_ROOT, 'biome_data/biome_commons.json')).map(_colorize);
}
