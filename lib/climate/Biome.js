...
var GLOBE_data_reader = require('./Elevation');

var Planet = require('./../Planet');
var reader = require('./Elevation.js');
...
Biome.biome_data = function(){

    var GeoSphere = require('./../../index');
    var biome_data = require(path.resolve(GeoSphere.CLIMATE_ROOT, 'biome_data/biomes.json'));
...
Biome.make_legend = function (file, callback) {
    var biome_data = Biome.biome_data();
...
_.extend(Biome.prototype, {
    ...
    load: function (callback) {
        var GeoSphere = require('./../../index');
        var BIOME_FILE = path.resolve(GeoSphere.CLIMATE_ROOT, 'biome_data/biome-results.txt');
        var self = this;

        var index = new GLOBE_data_reader.Index();
        index.init(function () {
