...
function _update() {
	...
	this.earth_sphere.rotation.y = this.hour * Math.PI / 12;
...
module.exports = function () {
	this.sun_sphere = new THREE.Mesh(new THREE.SphereGeometry(SUN_RADIUS, 6, 6), sunMaterial);
	this.earth_sphere = new THREE.Mesh(new THREE.SphereGeometry(EARTH_RADIUS, 6, 6), earthMaterial);
	...
	//this.ec_counter_rotation.add(this.earth_sphere);
