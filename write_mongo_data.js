...
console.log('writing mongo data for %s: depths %s ... %s, %s px x %s px images', mode, min_depth, max_depth, width, height)

require('./lib/mongo/' + mode)(function (err) {
    if (err) throw err;
    console.log('done with mongo data for %s', mode);
